...
// get add-user form data if submit btn is clicked
...
if(isset($_POST['submit'])) {
    ...
    if(!$firstname){
        ...
        if($createpassword !== $confirmpassword){
            ...
            //  check if username or email aready exist in database
            ...
            if(mysqli_num_rows($user_check_result) > 0) {
                ...
                // WORK ON AVATAR
                // rename avatar
                $time = time();   // make each image name unique using current timeatamp 
