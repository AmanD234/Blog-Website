...
// make sure update post button was clicked
if (isset($_POST['submit'])) {
    ...
    if (!$title) {
        ...
        if ($thumbnail['name']) {
            ...
            // work on new thumbnail --- rename the image
    ...
    if ($_SESSION['edit-post']) {
        // redirect back to manage post page if there was any problem
        
        header('location: ' . ROOT_URL . 'admin/index.php');
        die();
    } else {
        // set is_featured of all posts to 0 if is_featured of current post is 1 
        if ($is_featured == 1) {
